...
#define CLOSE_SWITCH_ON	0x01
#define OPEN_SWITCH_ON	0x02
#define FIND_DEVICE			0x03
#define LOST_DEVICE			0x04

#define LOCK_STATUS     0x01
#define LIVING_STATUS   0x02
#define IS_LOCK(x)      (0x01 & x)
#define IS_LIVING(x)    (0x02 & x)

#define DEVICE_ADDRESS {0xf6, 0xc4, 0x9f, 0xa8, 0xa0, 0x04}
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    uint8_t adv_name_len = 0;
		int8_t device_addr[] = DEVICE_ADDRESS;
    switch (event) {
    case ESP_GAP_BLE_SCAN_PARAM_SET_COMPLETE_EVT: {
        //the unit of the duration is second
        uint32_t duration = 0;
        esp_ble_gap_start_scanning(duration);
        ESP_LOGI(GATTC_TAG, "scan start set param");
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            ...
            ESP_LOGI(GATTC_TAG, "address type:%d", scan_result->scan_rst.ble_addr_type);
            ESP_LOGI(GATTC_TAG, "dev_type:%d", scan_result->scan_rst.dev_type);
            if(0 == memcmp(device_addr , scan_result->scan_rst.bda, 6)){
							ESP_LOGI(GATTC_TAG, "itti!!!");
						}
...
void app_main()
{
    ...
    if (local_mtu_ret){
		...
		//bta_sys_set_trace_level(BT_TRACE_LEVEL_VERBOSE);
}
